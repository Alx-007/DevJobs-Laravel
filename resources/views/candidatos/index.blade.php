                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="md:flex md:justify-center p-5">
                        <ul class="divide-y divide-gray-200 w-full">
                            @forelse ($vacante->candidatos as $candidato )
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        ...
                                        class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-indigo-800 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-indigo-50">
                                            Ver CV
                                        </a>
                                    </div>
                            ...
                            @empty
                                <p class="p-3 text-center text-sm text-gray-500 font-bold">No hay candidatos aún para este vacante</p>
                            @endforelse
                        </ul>
                    </div>    
