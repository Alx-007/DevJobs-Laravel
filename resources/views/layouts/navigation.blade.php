<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 p-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm text-white" href="{{ route('notificaciones') }}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (auth()->user()->rol === 2)
                    <div class="flex gap-1 items-center p-3">
                        <a class="mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm text-white" href="{{ route('notificaciones') }}">
                            {{ auth()->user()->unreadNotifications->count() }}
                        </a>
