                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="mt-5 md:mt:0">
                            <a class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg block text-center" href="{{ route('vacantes.show', $vacante->id) }}">Ver Vacante</a>
                        </div>
                    </div>
                @empty
